    ...
    render() {
        ...
        return (
            <>
                ...
                <h2 onClick={this.handleClickTittle1} class="point">{this.state.text1Active ? defText1 : <><p>{p1Text1}</p><p>{p2Text1}</p><p>{p3Text1}</p><p>{p4Text1}</p> <p>{p5Text1}</p><p>{p6Text1}</p><p>{p7Text1}</p></>}</h2>
                <h2 onClick={this.handleClickTittle2} class="point">{this.state.text2Active ? defText2 : <p>{p1Text2}</p>}</h2>
                <h2 onClick={this.handleClickTittle3} class="point">{this.state.text3Active ? defText3 : <p>{p1Text3}</p>}</h2>
            </>
        )
    }
}
